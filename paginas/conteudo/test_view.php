...
<div style="max-width: 400px; background-color: white; padding: 20px; border-radius: 8px; box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1); display: flex; flex-direction: column; gap: 10px;">
    ...
    <a href="?section=update_projeto&idUpdate=<?php echo $show->id_project; ?>" style="text-decoration: none; color: #0073e6; font-weight: bold; font-size: 14px;">ALterar</a>
    <a href="?section=del_projeto&idDel=<?php echo $show->id_project; ?>" onclick="confirm('Tem certeza? Esta ação não pode ser desfeita!')" style="text-decoration: none; color: #0073e6; font-weight: bold; font-size: 14px;">Excluir</a>
</div>
</div>
            </section>
